...
MasterDataFrame <- read.csv("data/MasterDataFrame.csv") #sometimes this doesnt run in rmd but will run in console
data <-MasterDataFrame
abiotic_mdf<-merge(data, abiotic, by.x=c("Latitude","Longitude","Species"), by.y=c("Latitude","Longitude","Species"))

setwd("/Users/mackenziekawahara/Desktop/2020_BayLab_Coral_Group/Coral-Group-Meta-Analysis")
write.csv(abiotic_mdf,"data/MasterDataFrame.csv")
